  ...
  <tr> 
    ...
    <td bgcolor="#FFFFFF"><TABLE width="460" border="0" cellpadding="0" cellspacing="0">
      ...
      <TABLE width="460" border="0" cellpadding="0" cellspacing="0">
        ...
        <TR> 
          <TD class="EspecialesYellow"><strong>Sale</strong></TD>
          <TD class="EspecialesGreen"><strong>Entra</strong></TD>
	...
	if(mysql_num_rows($resultado)!=0){ 
      ...
      <TABLE width="460" border="0" cellpadding="0" cellspacing="0">
        ...
        <TR align="center"> 
          <TD class="EspecialesYellow"><b><? echo $row["primer_club"] ?></b></TD>
          <TD class="EspecialesGray"><b><? echo $row["segundo_club"] ?></b></TD>
        </TR>
        <? 
	...
	for($orden=1;$orden<=22;$orden++){ ?>
      ...
      <TABLE width="460" border="0" cellpadding="0" cellspacing="0">
        ...
        <TR> 
          <TD class="EspecialesYellow"><strong>Jugador </strong></TD>
          <TD class="EspecialesGreen"><strong>Tipo</strong></TD>
          <TD align="center" class="EspecialesGray">Minuto</TD>
        </TR>
	...
	if(mysql_num_rows($resultado)!=0){ 
      ...
      <TABLE width="460" border="0" cellpadding="0" cellspacing="0">
        ...
        <TR> 
          <TD class="EspecialesYellow"><strong>Jugador</strong></TD>
          <TD class="EspecialesGreen"><strong>Tarjeta</strong></TD>
          <TD align="center" class="EspecialesGray">Minuto</TD>
        </TR>
